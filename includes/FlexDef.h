#ifndef	__C_COMPILER_FLEXDEF_H
#define	__C_COMPILER_FLEXDEF_H
...
enum storType {
	AUTO_T, REGISTER_T, EXTERN_T, STATIC_T, NULLS_T
};

enum signType {
	SIGNED_T, UNSIGNED_T, NULLI_T
};

enum lenType {
	SHORT_T, LONG_T, NULLL_T
};
...
public:
	...
	abstractNode* OP;
	abstractNode* RHS;
	parserNode(tokType id, std::string val, abstractNode* LHS, abstractNode* OP,
			abstractNode* RHS, int linenum);
	virtual ~parserNode();
};
...
public:
	...
	abstractNode* repeat;
	forNode(tokType id, std::string val, abstractNode* initial,
...
public:
	...
	condNode(tokType id, std::string val, abstractNode* condition,
...
public:
	abstractNode* code;
	abstractNode* def;
	functionNode(tokType id, std::string val, abstractNode* functionDef,
			abstractNode* code, int linenum);
...
public:
	...
	functionDecNode(tokType id, variableNode* variableDef,
